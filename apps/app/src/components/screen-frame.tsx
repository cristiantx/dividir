...
const insetClassMap: Record<ScreenFrameInset, string> = {
  content: "pb-[calc(7rem+var(--safe-area-bottom))]",
  flow: "pb-[calc(11rem+var(--safe-area-bottom))]",
  tabs: "pb-[calc(8rem+var(--safe-area-bottom))]",
};
...
export function ScreenFrame({
  ...
  return (
    <main className={cn("min-h-dvh bg-obsidian-0", insetClassMap[inset], mainClassName)}>
      <header className="app-header-safe sticky top-0 z-20 grid grid-cols-[auto_1fr_auto] items-center gap-3 border-b border-obsidian-300 bg-obsidian-0/98 px-6 backdrop-blur">
