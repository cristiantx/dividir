  ...
  return (
    <main className="min-h-dvh bg-obsidian-0 px-6 pb-28 pt-10">
      ...
      <section className="surface-glow rounded-[28px] border border-obsidian-300 bg-obsidian-100 p-6">
        ...
        <h2 className="font-display text-xl font-semibold text-ink-50">Cristian</h2>
        <p className="mt-2 text-sm leading-6 text-ink-300">
          Esta pantalla se mantiene mínima en v1: sesión, capacidad offline y salida.
        </p>
      </section>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-ink-300">
                Convex Auth ya está cableado. Falta conectar el deployment real.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="surface-glow rounded-[24px] border border-obsidian-300 bg-obsidian-100 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-ink-300">
                Dexie ya tiene tablas para caché de grupos y cola de mutaciones.
              </p>
            </div>
          </div>
        </div>

        <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-full border border-obsidian-300 bg-transparent py-4 font-display text-sm font-semibold uppercase tracking-[0.22em] text-ink-300 transition hover:border-rose-500 hover:text-rose-500">
